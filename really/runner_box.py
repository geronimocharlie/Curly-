...
class RunnerBox:
    ...
    @kwargs:
        ...
        input_shape: defaults to the shape of the envs reset state
        is_tf: boolean, if model is tensorflow -> has to be initialized
    """
        ...
        while step < num_steps:
            ...
            while not done:
                ...
                agent_out = self.agent.act_experience(
                    np.expand_dims(stete, axis=0), self.return_log_prob
                )
                # S
