...
class Agent:
    ...
    Agent wrapper:
        @args
            ...
            action_sampling_type: string, supported are 'thompson', 'epsilon_greedy', 'discrete_policy' and 'continous_normal_diagonal'
    ...
    def act_experience(self, state, return_log_prob=False):
        ...
        if self.action_sampling_type == "epsilon_greedy":
            ...
            output["action"] = action
            #logging.warning('but why are you doing continuos??')
    ...
    def log_prob(self, state, action, return_entropy=False):
        output = {}
